              ...
              >
                {products.map((product) => {
                  return (
                    ...
                    <br />
                    <div>
                    <span style={{marginLeft:"96px",background:"white",border:" 0.6px solid #9B9B9B",boxSizing:"border-box",width:"100.32px",height:"36.48px",borderRadius:"5.2px",marginBottom:"33.52px"}}><span style={styles.quantity} className="substractQuantity">-</span><span className="productQuantity">1</span><span className="addQuatity" style={styles.quantity}>+</span></span>
                      <span style={{marginLeft:"23.68px",fontSize:"12px",}}>Totaal <span style={{color:"#EB665C",fontSize:"24px",marginLeft:"9px",fontWeight:"500",}}>9.00$</span> <button className="btn btn-primary" style={{background:"#EB665C",border:"none",marginLeft:"17px",}}>Voeg toe</button></span>
                      </div>
                      </div>
